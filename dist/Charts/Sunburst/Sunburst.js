...
var _sunburst = require('highcharts/modules/sunburst');
...
var Sunburst = function (_Component) {
  ...
  _createClass(Sunburst, [{
    ...
    value: function componentDidMount() {
      (0, _sunburst2.default)(_highcharts2.default);
      var data = [{
        'id': '0.0',
        'parent': '',
        'name': 'The World'
      ...
      _highcharts2.default.getOptions().colors.splice(0, 0, 'transparent');
      _highcharts2.default.chart('sunburst-chart-container', {
        chart: {
          height: '100%'
        },
        title: {
    ...
    value: function render() {
      return _react2.default.createElement('div', { id: "sunburst-chart-container" });
    }
  }]);
