...
var Dismiss = function (_Component) {
  ...
  function Dismiss() {
    ...
    return _possibleConstructorReturn(this, (Dismiss.__proto__ || Object.getPrototypeOf(Dismiss)).apply(this, arguments));
  }
  ...
  _createClass(Dismiss, [{
    ...
    value: function _buildClasses() {
      var classes = ['alert'];
      var type = 'alert-' + this.props.type;
      classes.push(type);
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: this._buildClasses(), role: 'alert' },
        _react2.default.createElement(
          'strong',
          null,
          this.props.strong
