...
var InfluencerMedia = function (_Component) {
  _inherits(InfluencerMedia, _Component);

  function InfluencerMedia(props) {
    _classCallCheck(this, InfluencerMedia);

    var _this = _possibleConstructorReturn(this, (InfluencerMedia.__proto__ || Object.getPrototypeOf(InfluencerMedia)).call(this, props));

    _this._onImageLoadError = _this._onImageLoadError.bind(_this);
    return _this;
  }

  _createClass(InfluencerMedia, [{
    ...
    value: function _getImageSizeClassName() {
      var size = String(this.props.size);
    ...
    value: function render() {
      return _react2.default.createElement(
        'figure',
        { className: (0, _Helpers.getClasses)('figure', this._getImageSizeClassName(), this.props.classes) },
...
exports.default = InfluencerMedia;